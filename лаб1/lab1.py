...
emails = pd.read_csv("sms-spam-corpus.csv", encoding='windows-1252')
...
ax1.set_xlabel('Довжина слів')
ax1.set_ylabel('Кількість')
ax1.set_title('Розподіл по довжині Ham слів - Середня довжина'+" "+str(avg_h1)+"("+str(avg_h)+")")
...
ax2.set_xlabel('Довжина слів')
ax2.set_ylabel('Кількість')
ax2.set_title('Розподіл по довжині Spam слів - Середня довжина'+" "+str(avg_s1)+"("+str(avg_s)+")")
...
ax3.set_xlabel('Довжина повідомлень')
ax3.set_ylabel('Кількість')
ax3.set_title('Розподіл по довжині Ham повідомлень - Середня довжина'+" "+str(avg_notif_ham1)+"("+str(avg_notif_ham)+")")
...
ax4.set_xlabel('Довжина повідомлень')
ax4.set_ylabel('Кількість')
ax4.set_title('Розподіл по довжині  Spam повідомлень - Середня довжина'+" "+str(avg_notif_spam1)+"("+str(avg_notif_spam)+")")
...
# запись спам-соообщений обратно в файл
...
ax5.set_title('Частотний аналіз Ham')
ax5.set_xticks(x5)
...
ax6.set_title('Частотний аналіз Spam')
ax6.set_xticks(x6)
